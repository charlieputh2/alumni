							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_gallery" type="button" data-id="<?php echo $row['id'] ?>" data-about="<?php echo htmlspecialchars($row['about'] ?? '') ?>" data-src="<?php echo isset($img[$row['id']]) && is_file($fpath.'/'.$img[$row['id']]) ? $fpath.'/'.$img[$row['id']] :'' ?>" >Edit</button>
...
<style>
	...
	@media (max-width: 768px) {
		.gimg { max-width: 30vw; max-height: 12vh; }
		img#cimg { max-height: 20vh; }
		.card-body { padding: 0.75rem; }
		td .btn { font-size: 0.75rem; padding: 4px 8px; display: block; width: 100%; margin-bottom: 4px; }
	}
