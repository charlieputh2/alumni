...
@media (max-width: 768px) {
    ...
    .alumni-list { flex-direction: column; }
    .alumni-img { width: 100%; max-height: 200px; }
    .alumni-list .card-body { width: 100%; }
    .alumni-img img { border-radius: 50%; max-width: 120px; max-height: 120px; margin: 10px auto; display: block; }
    .card { margin-bottom: 1rem; }
    .card-body { padding: 1rem; }
    .col-md-4.item { padding: 0 5px; }
}
@media (max-width: 576px) {
    h1, h2, h3 { font-size: 1.2rem; }
    .btn { width: 100%; margin-bottom: 0.5rem; }
    body { font-size: 0.9rem; }
    .filter-txt { font-size: 0.85rem; }
    .input-group { flex-direction: column; }
    .input-group .form-control { border-radius: 0.25rem !important; margin-bottom: 0.5rem; }
    .input-group .input-group-prepend { display: none; }
}
</style>
